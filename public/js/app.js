class App {
    ...
    navigateTo(view) {
        ...
        const titleMap = {
            ...
            'bap': 'BAST', 'invoices': 'Invoice Management', 'proforma-invoices': 'Proforma Invoices', 'settings': 'Settings', 'users': 'Users'
        };
        ...
        try {
            switch (view) {
                ...
                case 'proforma-invoices': window.ui.renderProformaInvoiceManagement(); break;
